...
class PromotionHeader {
    ...
    private changeTextOnButton(item: PromotionItem, level_5_span: HTMLSpanElement): HTMLSpanElement {
        if( item.loading ) {
            ...
            level_5_span.innerText = "Trailer";
    ...
    private onClickTrailer = (ev: MouseEvent): void => {
        ...
        try {
            ...
            if( bigImage ) {
                ...
                this.currentItem.btnUI.level_5.innerText = "Loading";
    ...
    private onEnterTrailer = (): void => {
        ...
        this.currentItem.btnUI.level_5.innerText = "Stop";

        setTimeout(() => {
            this.currentItem.youtube.getIframe().setAttribute('style', this.currentItem.youtube.getIframe().getAttribute('style').replace(ON_START_ANIMATION_ENDED_TRAILER_1, ON_START_ANIMATION_ENDED_TRAILER_2));
        }, 400);
    }
